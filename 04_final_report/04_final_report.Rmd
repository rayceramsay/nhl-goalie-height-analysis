...
```{r, echo=FALSE, fig.height=3, fig.align="center", fig.cap="Estimated smooth effect of height on GAA and their corresponding 95\\% confidence intervals from the GAM with a Gamma distribution and log link."}
...
```{r, echo=FALSE, fig.height=3, fig.align="center", fig.cap="Estimated smooth effect of height on SV% and their corresponding 95% confidence intervals from the GAM with a Beta distribution and logit link."}
